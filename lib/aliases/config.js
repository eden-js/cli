...
} else if (fs.existsSync(`${global.appRoot}/config.js`)) {
...
const configLocations = loader.getFiles('edenconfig.js', loader.getLocations(nconf.get('modules') || [], 'bundles').map(p => p.slice(0, -'bundles/'.length))).reverse();
