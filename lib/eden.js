...
var engine   = require (global.appRoot + '/lib/util/engine');
...
class eden {
    ...
    _registerAliases () {
        ...
        alias ('user', global.appRoot + '/lib/bundles/user/model/user.js');
        alias ('acl',  global.appRoot + '/lib/bundles/user/model/acl.js');

        // register alt-core helpers
        alias ('socket',   global.appRoot + '/lib/bundles/socket/helper/socketHelper.js');
        alias ('datagrid', global.appRoot + '/lib/bundles/datagrid/helper/datagridHelper.js');

        // register util aliases
        alias ('acl-util', global.appRoot + '/lib/util/acl.js');
    }
    ...
    _buildRouter () {
        ...
        co (function * () {
            ...
            var userCtrl = '/lib/bundles/user/controller/userController';
