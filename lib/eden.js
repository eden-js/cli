...
class eden {
    ...
    _registerAliases () {
        ...
        alias ('grid',   global.appRoot + '/lib/bundles/grid/helpers/grid.js');
        alias ('alert',  global.appRoot + '/lib/bundles/alert/helpers/alert.js');
    ...
    async _buildRouter () {
        ...
        var UserCtrl = await that.require (global.appRoot + userCtrl);
        ...
        for (var i = 0; i < priorities.length; i ++) {
            ...
            for (var type in types) {
                ...
                for (var route in routeType) {
                    // await controller
                    var ctrl = await that.controller (routeType[route].controller);
