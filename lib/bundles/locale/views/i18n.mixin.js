...
riot.mixin ('i18n', {
  ...
  't' : function (str) {
    ...
    // check i18n
    if (this.i18n && this.i18n.defaults && (!this.i18n.initialized || !this.i18n.loaded)) {
      // check default
      if (this.i18n.defaults[JSON.stringify (arguments)]) return this.i18n.defaults[JSON.stringify (arguments)];
    }

    // check if exists
    if (this.i18n) return this.i18n.t.apply (this.i18n, arguments);
  },
  ...
  'lang' : function () {
    // check if exists
    if (this.i18n) return this.i18n.lang.apply (this.i18n, arguments);
  }
});
