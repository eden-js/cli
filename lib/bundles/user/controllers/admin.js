...
class admin extends controller {
    ...
    async deleteSubmitAction (req, res) {
        ...
        // render user admin page
        var Grid = await that._grid ().render ();
    ...
    _grid () {
        ...
        userGrid.column ('_id', {
            ...
            'format' : async (col, row) => {
                return [
                    '<a href="/admin/users/' + row.get ('_id').toString () + '/edit" class="btn btn-sm btn-primary">Edit</a>',
                    ' ',
                    '<a href="/admin/users/' + row.get ('_id').toString () + '/delete" class="btn btn-sm btn-danger">Delete</a>'
                ].join ('');
            }
        });
